...
function TeacherWorkload() {
  ...
  const filteredSubjectsForSection = useMemo(() => {
    ...
    if (!selectedSection || !selectedSection.program_id) return subjects;

    // Filter subjects that belong to the same program
    // Note: If subjects don't have program_id, they'll all be shown
    return subjects.filter(subject =>
      !subject.program_id || subject.program_id === selectedSection.program_id
    );
            ...
            <>
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 mb-6">
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <button
                    onClick={() => { fetchTeachers(); fetchUnassignedClasses(); }}
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                    ...
                    {!createForm.section_id ? (
                      <div className="space-y-2">
                        ...
                        {sections.length === 0 && (
                          <div className="text-sm text-gray-500 text-center py-8">No sections available</div>
                        )}
                      </div>
                    ) : (
                      <div>
